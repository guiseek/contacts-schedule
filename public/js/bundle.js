...
$templateCache.put('./app.html','<app-nav user="$ctrl.user" on-logout="$ctrl.logout();"></app-nav><div class="container-fluid"><div class="row"><div class="col-md-3"><app-sidebar></app-sidebar></div><div class="col-md-9"><div ui-view></div></div></div></div>');
...
$templateCache.put('./contact.html','<div class="panel panel-default"><div class="panel-heading" ng-bind="$ctrl.contact.name"></div><div class="panel-body"><div class="row"><div class="col-sm-5 col-xs-12"><p><i class="fa fa-phone"></i> <span ng-bind="$ctrl.contact.phone || \'Sem telefone\'"></span></p></div><div class="col-sm-7 col-xs-12"><p><i class="fa fa-envelope-o"></i> <span ng-bind="$ctrl.contact.email || \'Sem email\'"></span></p></div><div class="col-sm-5 col-xs-12"><p><i class="fa fa-tag"></i> <span ng-bind="$ctrl.contact.tag.label || \'Sem etiqueta\'"></span></p></div><div class="col-sm-7 col-xs-12"><p><i class="fa fa-laptop"></i> <span ng-bind="$ctrl.contact.job || \'Sem profiss\xE3o\'"></span></p></div><div class="col-xs-12"><p><i class="fa fa-home"></i> <span ng-bind="$ctrl.contact.location || \'Sem endere\xE7o\'"></span></p></div></div></div><div class=""><div class="btn-group btn-group-justified btn-group-lg" role="group" aria-label="..."><a ng-if="$ctrl.contact.social.facebook" href="{{$ctrl.contact.social.facebook}}" target="_blank" class="btn btn-primary"><i class="fa fa-facebook-square"></i> </a><a ng-if="$ctrl.contact.social.google" href="{{$ctrl.contact.social.google}}" target="_blank" class="btn btn-danger"><i class="fa fa-google-plus"></i> </a><a ng-if="$ctrl.contact.social.github" href="{{$ctrl.contact.social.github}}" target="_blank" class="btn btn-default"><i class="fa fa-github"></i> </a><a ng-if="$ctrl.contact.social.twitter" href="{{$ctrl.contact.social.twitter}}" target="_blank" class="btn btn-info"><i class="fa fa-twitter"></i> </a><a ng-if="$ctrl.contact.social.linkedin" href="{{$ctrl.contact.social.linkedin}}" target="_blank" class="btn btn-primary"><i class="fa fa-linkedin"></i> </a><a ng-click="$ctrl.selectContact()" class="btn btn-success"><i class="fa fa-pencil"></i></a></div></div></div>');
$templateCache.put('./contact-detail.html','<div class="contact"><form name="contactDetailForm" novalidate><div class="row"><div class="col-md-6"><h3 class="page-header">Dados pessoais</h3><div class="form-group"><label>Nome</label><input type="text" name="name" class="form-control" validate-class="{success: \'has-success\', \'error\': \'has-error\'}" minlength="8" required ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.name"></div><div class="form-group"><label>Telefone</label><input type="text" name="phone" class="form-control" validate-class="{success: \'has-success\', \'error\': \'has-error\'}" minlength="8" required ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.phone"></div><div class="form-group"><label>Email</label><input type="email" name="email" class="form-control" validate-class="{success: \'has-success\', \'error\': \'has-error\'}" required="required" ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.email"></div><div class="form-group"><label>Profiss\xE3o</label><input type="text" name="jobTitle" class="form-control" ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.job"></div><div class="form-group"><label>Endere\xE7o</label><input type="text" name="location" class="form-control" ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.location"></div></div><div class="col-md-6"><h3 class="page-header">Dados sociais</h3><div class="form-group"><label>Facebook</label><input type="text" name="facebook" class="form-control" ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.social.facebook"></div><div class="form-group"><label>Google+</label><input type="text" name="google" class="form-control" ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.social.google"></div><div class="form-group"><label>GitHub</label><input type="text" name="github" class="form-control" ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.social.github"></div><div class="form-group"><label>Twitter</label><input type="text" name="twitter" class="form-control" ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.social.twitter"></div><div class="form-group"><label>LinkedIn</label><input type="text" name="linkedin" class="form-control" ng-change="$ctrl.updateContact();" ng-model-options="{\n              \'updateOn\': \'default blur\',\n              \'debounce\': {\n                \'default\': 250,\n                \'blur\': 0\n              }\n            }" ng-model="$ctrl.contact.social.linkedin"></div></div></div><div class="row"><div class="col-md-9"><contact-tag tag="$ctrl.contact.tag" on-change="$ctrl.tagChange($event);"></contact-tag></div><div class="col-md-3 text-right"><div ng-if="$ctrl.isNewContact"><button class="btn btn-success" ng-disabled="contactDetailForm.$invalid" ng-click="$ctrl.saveContact();"><i class="fa fa-check"></i> Salvar contato</button></div><div ng-if="!$ctrl.isNewContact"><button class="btn btn-danger" ng-click="$ctrl.deleteContact();"><i class="fa fa-trash-o"></i> Apagar contato</button></div></div></div></form></div>');
...
$templateCache.put('./contacts.html','<!--<div class="list-group"\n  ng-if="$ctrl.filteredContacts.length">\n  <a class="list-group-item" ng-repeat="contact in $ctrl.filteredContacts">\n    <contact\n      contact="contact"\n      on-select="$ctrl.goToContact($event);">\n    </contact>\n  </a>\n</div>--><div class="row" ng-if="$ctrl.filteredContacts.length"><div class="col-md-6" ng-repeat="contact in $ctrl.filteredContacts"><contact contact="contact" on-select="$ctrl.goToContact($event);"></contact></div></div><div class="alert alert-warning" ng-if="!$ctrl.filteredContacts.length"><i class="glyphicon glyphicon-alert"></i> N\xE3o tem ningu\xE9m aqui...</div>');}]);})(window.angular);